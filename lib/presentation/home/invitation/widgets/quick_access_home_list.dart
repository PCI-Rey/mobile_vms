...
class QuickAccessHomeList extends StatefulWidget {
  const QuickAccessHomeList({super.key});

  @override
  State<QuickAccessHomeList> createState() => _QuickAccessHomeListState();
}

class _QuickAccessHomeListState extends State<QuickAccessHomeList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (controller.quickAccessInvitations.isEmpty) {
    ...
    void updateCarousel() {
      ...
      final filtered = controller.quickAccessInvitations.where((item) {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                vSpace(context, 8),
                Text(
                  'No quick access visits found for this date.',
                  style: TextStyle(
        ...
        children: [
          ...
          Align(
            ...
            child: TextButton.icon(
              onPressed: () {
                Get.to(() => const SendInvitationPage(initialTab: 2));
              },
              icon: Icon(Icons.arrow_forward_rounded, size: rw(context, 16)),
              label: const Text('Show More Quick Access'),
