...
class AppColors {
  ...
  static const Color error200 = Color(0xFFFEE4E2);
  static const Color error400 = Color(0xFFF97066);
  static const Color error500 = Color(0xFFF04438);
  static const Color blocked = Color(0xFF480500);
  static const Color evacuate = Color(0xFFB42318);

  // Warning
  static const Color warning100 = Color(0xFFFFF5F3);
  static const Color warning500 = Color(0xFFFDB022);

  // Success
  static const Color success100 = Color(0xFFFFF5F3);
  static const Color success500 = Color(0xFF32D583);

  // Info
  static const Color info100 = Color(0xFFE8F1FB);
  static const Color info500 = Color(0xFF36BFFA);
}
